import { 
    Controller, Get, Post, Param, Delete, Body, Put, UseGuards, Req, ForbiddenException, Logger 
} from '@nestjs/common';
...
export class UsersController {
    ...
    private readonly logger = new Logger(UsersController.name); // Logger pour debug
